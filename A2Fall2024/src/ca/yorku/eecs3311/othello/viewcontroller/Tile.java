...
/**
 * A Tile is a Button object that knows how to update to reflect
...
public class Tile extends Button implements Observer{
	...
	/**
	 * Constructs a Button to represent an Othello game tile
	 * 
	 ...
	 */
	public Tile(Othello othello, int row, int col, Hints hints) {
		this.setText("");
